...
**
** Created: Sat Jun 8 16:46:55 2013
...
public:
    ...
    QAction *action_NoSpectral_OpenCL_CPUs;
    QAction *action_LuxBall_Sky;
    QAction *action_Sala;
    QAction *action_NoSpectral_OpenCL_Custom;
    QAction *action_Room;
    QAction *action_Spectral_Hybrid_GPUs;
    QAction *action_Spectral_Hybrid_Custom;
    QAction *action_Spectral_BiDir;
    QAction *action_Spectral_Path;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        action_NoSpectral_OpenCL_CPUs_GPUs = new QAction(MainWindow);
        action_NoSpectral_OpenCL_CPUs_GPUs->setObjectName(QString::fromUtf8("action_NoSpectral_OpenCL_CPUs_GPUs"));
        action_NoSpectral_OpenCL_CPUs_GPUs->setCheckable(true);
        ...
        action_NoSpectral_OpenCL_CPUs = new QAction(MainWindow);
        action_NoSpectral_OpenCL_CPUs->setObjectName(QString::fromUtf8("action_NoSpectral_OpenCL_CPUs"));
        action_NoSpectral_OpenCL_CPUs->setCheckable(true);
        ...
        action_NoSpectral_OpenCL_Custom = new QAction(MainWindow);
        action_NoSpectral_OpenCL_Custom->setObjectName(QString::fromUtf8("action_NoSpectral_OpenCL_Custom"));
        action_NoSpectral_OpenCL_Custom->setCheckable(true);
        action_Room = new QAction(MainWindow);
        action_Room->setObjectName(QString::fromUtf8("action_Room"));
        action_Room->setCheckable(true);
        action_Spectral_Hybrid_GPUs = new QAction(MainWindow);
        action_Spectral_Hybrid_GPUs->setObjectName(QString::fromUtf8("action_Spectral_Hybrid_GPUs"));
        action_Spectral_Hybrid_GPUs->setCheckable(true);
        action_Spectral_Hybrid_Custom = new QAction(MainWindow);
        action_Spectral_Hybrid_Custom->setObjectName(QString::fromUtf8("action_Spectral_Hybrid_Custom"));
        action_Spectral_Hybrid_Custom->setCheckable(true);
        action_Spectral_BiDir = new QAction(MainWindow);
        action_Spectral_BiDir->setObjectName(QString::fromUtf8("action_Spectral_BiDir"));
        action_Spectral_BiDir->setCheckable(true);
        action_Spectral_Path = new QAction(MainWindow);
        action_Spectral_Path->setObjectName(QString::fromUtf8("action_Spectral_Path"));
        action_Spectral_Path->setCheckable(true);
        action_NoSpectral_Hybrid_GPUs = new QAction(MainWindow);
        action_NoSpectral_Hybrid_GPUs->setObjectName(QString::fromUtf8("action_NoSpectral_Hybrid_GPUs"));
        action_NoSpectral_Hybrid_Custom = new QAction(MainWindow);
        ...
        menu_Mode->addAction(action_NoSpectral_OpenCL_GPUs);
        menu_Mode->addAction(action_NoSpectral_OpenCL_CPUs_GPUs);
        menu_Mode->addAction(action_NoSpectral_OpenCL_CPUs);
        menu_Mode->addAction(action_NoSpectral_OpenCL_Custom);
        menu_Mode->addAction(action_NoSpectral_Hybrid_GPUs);
        menu_Mode->addAction(action_NoSpectral_Hybrid_Custom);
        menu_Mode->addAction(action_NoSpectral_Path);
        menu_Mode->addSeparator();
        menu_Mode->addAction(action_Spectral_Hybrid_GPUs);
        menu_Mode->addAction(action_Spectral_Hybrid_Custom);
        menu_Mode->addAction(action_Spectral_Path);
        menu_Mode->addSeparator();
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        action_NoSpectral_OpenCL_CPUs_GPUs->setText(QApplication::translate("MainWindow", "Benchmark (No Spectral Rendering, OpenCL-only CPUs + GPUs)", 0, QApplication::UnicodeUTF8));
        action_Pause->setText(QApplication::translate("MainWindow", "&Pause", 0, QApplication::UnicodeUTF8));
        action_NoSpectral_OpenCL_CPUs->setText(QApplication::translate("MainWindow", "Benchmark (No Spectral Rendering, OpenCL-only CPUs-only)", 0, QApplication::UnicodeUTF8));
        ...
        action_NoSpectral_OpenCL_Custom->setText(QApplication::translate("MainWindow", "Benchmark (No Spectral Rendering, OpenCL-only selected devices only)", 0, QApplication::UnicodeUTF8));
        ...
        action_Spectral_Hybrid_GPUs->setText(QApplication::translate("MainWindow", "Benchmark (Spectral Rendering, Hybrid C++/OpenCL GPUs-only)", 0, QApplication::UnicodeUTF8));
        action_Spectral_Hybrid_Custom->setText(QApplication::translate("MainWindow", "Benchmark (Spectral Rendering, Hybrid C++/OpenCL selected devices only)", 0, QApplication::UnicodeUTF8));
